...
space.visualize(format: :html, x: :iterate_requests, y: :iterate_processes, function: :inference, output: "./examples/11_visualization/viz.html", show_legend: false, show_z_title: false, show_grid: true, equal_axes: true)
