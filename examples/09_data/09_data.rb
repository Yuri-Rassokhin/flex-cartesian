...
space = FlexCartesian.new(source: :xlsx, uri: "./examples/09_visualization/yolo-arm-a1.xlsx", dimensions: [:iterate_iteration, :infra_shape, :iterate_requests, :iterate_processes] )
