Gem::Specification.new do |spec|
  ...
  spec.description   = "Supports dimension-agnostic iterators, named dimensions, tabular output, lazy/eager evaluation, progress bar, JSON/YAML loading, and export to Markdown/CSV."
